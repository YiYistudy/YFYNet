...
inputFolderPath = "."
resultNames = [												\
	"YeNetModel.pth", "YeNetResult" + os.sep + "training.txt", "YeNetResult" + os.sep + "testing.txt", 			\
	"YeNetResult" + os.sep + "trainingGeneralAccuracy.png", "YeNetResult" + os.sep + "trainingDetailedAccuracy.png", 		\
	"YeNetResult" + os.sep + "trainingGeneralLoss.png", "YeNetResult" + os.sep + "trainingDetailedLoss.png", 		\
	"YeNetResult" + os.sep + "trainingGeneralTime.png", "YeNetResult" + os.sep + "trainingDetailedTime.png", 		\
	"YeNetResult" + os.sep + "validationGeneralAccuracy.png", "YeNetResult" + os.sep + "validationDetailedAccuracy.png", 	\
	"YeNetResult" + os.sep + "validationGeneralLoss.png", "YeNetResult" + os.sep + "validationDetailedLoss.png", 		\
] + ["checkpoints" + os.sep + "YeNet_{0}.pt".format(i) for i in range(1, 21)]
commentSymbols = ["#", "@", "%", "//", "__"]
skipIfContains = "Differential"
doCropping = True
cropOffset = 30
...
def main() -> int:
	...
	for source in os.listdir(inputFolderPath):
		...
		if os.path.isdir(sourceFolder) and skipIfContains.lower() not in source.lower() and not isCommented(source):
